				...
				<div class="mt-1">
					<div class="col-12 scrollbar" style="height: 130px;">
						...
						<div class="input-group input-group-sm mb-2">
							...
							<textarea id="patntMemoDt" class="form-control patientInfoCss" cols="2" readonly="readonly"></textarea>
						</div>
					</div>
				</div>
				<!-- 환자 정보 끝 -->
					...
					success : function(res){
						...
						$(res).each(function(idx, item){
							...
							patientDropItemHtml = patientDropItem(this.patntNo, this.patntNm, this.patntAge, 
									...
									this.patntHsptlzAt, this.prtctorNm, this.prtctorTelno, this.patntMemo, this.patntHeight, this.patntBdwgh, this.patntBdp);
		...
		$(patientInput).keypress(function(event){
			if(event.which == 13){
				...
				selectPatientAjax(patntNo, patntNm, patntAge, patntRrno1, patntRrno2, patientBirth,
						patntSexdstn, patntTelno, patntHlthinsAt, patntHsptlzAt, prtctorNm, prtctorTelno, patntMemo, patntHeight, patntBdwgh, patntBdp);
				callBtnSelectPatientVital(patntNo);
				callBtnSelectPatient(patntNo)
				// 환자 전처방 생성
...
// 			selectPatientAjax(patntNo);
		...
		function selectPatientAjax(patntNo, patntNm, patntAge, patntRrno1, patntRrno2, patientBirth,
			...
			console.log(patntHeight, patntBdwgh, patntBdp, patntNo);
