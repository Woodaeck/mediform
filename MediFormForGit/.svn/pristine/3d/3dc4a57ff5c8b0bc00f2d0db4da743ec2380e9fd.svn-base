              ...
              <div class="card-body p-4 p-sm-5">
                ...
                <div class="row">
                	...
                	<div class="col-2 pe-2">
		       		     <div class="col-auto" style="display: flex; justify-content: flex-end;"><button class="btn btn-sm btn-falcon-primary" id="goLPPTBtn">PPT</button></div>
                	</div>
                	<div class="col-2 ps-0">
		       		     <div class="col-auto" style="display: flex; justify-content: flex-start;"><button class="btn btn-sm btn-falcon-primary" id="goQandABtn">Q&A</button></div>
                	</div>
       		    </div>
              </div>
            </div>
...
$(function(){
	...
	$("#goLPPTBtn").on('click',function(){
		location.href = "/mediform/ppt/home";
	});
	
	$("#goQandABtn").on('click',function(){
		location.href = "/mediform/ppt/qanda";
	});
